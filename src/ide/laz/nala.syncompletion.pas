// Nala:
// Forwarded hint mouse scroll events to form, minor addition but makes a big difference.
// Line 84
...
procedure TSynBaseCompletionHint.WMMouseWheel(var Message: TLMMouseEvent);
begin
  Self.Hide;
  FCompletionForm.WMMouseWheel(Message);
end;
